  ...
  return (
    <section id="reviews" className="py-16 px-4 bg-zinc-950">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        {testimonials.map((t) => (
          <div key={t.id} className="bg-zinc-900 p-8 rounded-2xl border border-zinc-800 hover:border-[#C0182A]/30 transition-colors">
            <Quote className="text-[#C0182A] mb-4 opacity-50" size={24} />
