  ...
  return (
    <section className="py-24 bg-zinc-950 px-4 border-t border-zinc-900">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-black text-center text-[#C0182A] mb-4">Frequently Asked Questions</h2>
          ...
          {faqData.map((item) => (
            <div key={item.id} className="border-b border-zinc-800 pb-4">
              <button 
                ...
                className="w-full flex justify-between items-center py-2 text-left hover:text-[#C0182A] transition-colors focus:outline-none"
              >
                <span className="font-bold text-white text-lg">{item.question}</span>
                <span className="text-[#C0182A]">
