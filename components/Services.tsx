...
export const Services: React.FC = () => {
  return (
    <section className="py-24 bg-gradient-to-b from-zinc-950 to-[#1a0505] border-t border-zinc-900">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-[#C0182A] transition-all duration-300 group flex flex-col">
              {/* Image Container */}
              <div className="h-48 sm:h-64 overflow-hidden relative">
                 <div className="absolute inset-0 bg-[#C0182A]/0 group-hover:bg-[#C0182A]/10 transition-colors z-10"></div>
                 <img 
                    src={service.image} 
                    alt={service.title} 
