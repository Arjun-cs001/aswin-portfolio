             ...
             <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-6">
                {steps.map((step) => (
                   <div key={step.id} className="relative z-10 flex flex-col items-center text-center group">
                      ...
                      {/* Number Circle */}
                      <div className="w-20 h-20 rounded-full bg-[#C0182A] text-white flex items-center justify-center text-3xl font-black mb-6 shadow-[0_0_20px_rgba(192,24,42,0.4)] group-hover:scale-110 transition-transform duration-300 border-4 border-zinc-950 relative">
                         {step.id}
                      </div>
